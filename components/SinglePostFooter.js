      ...
      <footer className='entry-footer'>
        <span className='cat-tags-links'>
          <span className='cat-links'>
            <svg viewBox='0 0 34 32' className='icon icon-folder-open' aria-hidden='true' role='img'>
          ...
          <span className='tags-links'>
            <svg viewBox='0 0 32 32' className='icon icon-hashtag' aria-hidden='true' role='img'>
