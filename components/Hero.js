...
export default () => (
  <div className='o-header has-header-image home twentyseventeen-front-page'>
        ...
        <div className='site-branding'>
          <div className='wrap'>
            <div className='site-branding-text'>
              <h1 className='site-title'><a href='http://wp.pixel2html.com/examples/nextjs/' rel='home'>Project react~nextjs</a></h1>
